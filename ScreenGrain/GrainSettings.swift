...
extension GrainSettings: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        hidesInCaptures = try values.decodeIfPresent(Bool.self, forKey: .hidesInCaptures) ?? false
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try values.encode(hidesInCaptures, forKey: .hidesInCaptures)
